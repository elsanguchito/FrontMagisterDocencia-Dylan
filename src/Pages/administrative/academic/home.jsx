    ...
    const sectionsData = [
        {
            ...
            link: '/Administrative/academic/questionI',
            icon: (
                <svg
        ...
        },
        {
            title: 'Rubricas',
            description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex ut quo possimus adipisci distinctio alias voluptatum blanditiis laudantium.',
            link: '/Administrative/academic/rubricHasQ',
            icon: (
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 opacity-80"
        ...
        {
            title: 'Evaluacion del profesor',
            description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex ut quo possimus adipisci distinctio alias voluptatum blanditiis laudantium.',
            link: '/Administrative/academic/EvaluateTeacher',
            icon: (
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 opacity-80"
